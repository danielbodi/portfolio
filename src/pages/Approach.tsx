    ...
    <div className="min-h-screen px-4 py-16 md:px-6 md:py-24">
      <div className="mx-auto max-w-5xl">
          ...
          {capabilities.map((capability) => {
            ...
            return (
              <section
                ...
                className="rounded-xl border border-gray-700/60 bg-gray-900/40 p-6 md:p-8"
              >
                <h2 id={`${capability.id}-heading`} className="mb-2 text-2xl font-bold text-gray-100">
                  {capability.title}
                </h2>
                <p className="mb-5 max-w-3xl text-gray-400">{capability.text}</p>
                <h3 className="mb-3 text-xs font-semibold uppercase tracking-wide text-gray-500">
                  In practice
                </h3>
                <ul className="mb-5 max-w-3xl space-y-2.5">
                  {points.map((point, i) => (
        ...
        <section aria-labelledby="standards-heading" className="mb-14">
          ...
          <ul className="grid max-w-4xl gap-2.5 sm:grid-cols-2">
            {[
